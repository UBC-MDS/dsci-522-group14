...
# pre-process data (test and train data sets. Also generate combined data set.)
...
# create exploratory data analysis figure (feature vs target distributions, correlation, target distributions etc. )
...
# tune and test model (Random Forest, SVM with RBF, Logistic Regression)
...
# render final report (Using HTML to work around known issue with Rmd->md issues with latex)
