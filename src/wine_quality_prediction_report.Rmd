...
output: 
  html_document:
    toc: true
bibliography: ../doc/wine_refs.bib
...
<p align="center">
  <img src=`r here("results", "eda_target.png")`>
</p>

Figure 1. Target Class Distribution

For this classification problem we determined that the classes were balanced and could begin splitting the data into train and test sets. For this task, an 80/20 train/test split was used. 
